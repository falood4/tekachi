...
class DStopics extends StatefulWidget {
  const DStopics({super.key});

  @override
  State<DStopics> createState() => _DStopicsState();
}

class _DStopicsState extends State<DStopics> {
  late Future<Map<String, int>> _topicsFuture;

  @override
  void initState() {
    super.initState();
    _topicsFuture = Topicservice().fetchTopicsMap(501, 507);
  }
