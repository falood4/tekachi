...
class ArithmeticAptitude extends StatefulWidget {
  ...
  @override
  State<ArithmeticAptitude> createState() => _ArithmeticAptitudeState();
}

class _ArithmeticAptitudeState extends State<ArithmeticAptitude> {
  late Future<Map<String, int>> _topicsFuture;

  @override
  void initState() {
    super.initState();
    _topicsFuture = Topicservice().fetchTopicsMap(1, 15);
  }
