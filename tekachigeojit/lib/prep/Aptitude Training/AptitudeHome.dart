  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(  
      ...
      appBar: AppBar(
        ...
        title: Text('Aptitude Training', style: TextStyle(color: const Color(0xFF8DD300),
        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                _trainingMenuItem(context, "Arithmetic Aptitude"),
                _trainingMenuItem(context, "Data Interpretation"),
                _trainingMenuItem(context, "Verbal Reasoning"),
                _trainingMenuItem(context, "Logical Reasoning")
              ],
            ),
          ),
        ),
